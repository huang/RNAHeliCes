/*
  ...
  gengetopt -i treekin.ggo --file-name=treekin_cmdline --include-getopt --default-optional --unamed-opts
...
const char *gengetopt_args_info_purpose = "Calculate a macrostate dynamics of biopolymers";

const char *gengetopt_args_info_usage = "Usage: treekin_hi [OPTIONS]... [FILES]...";
...
const char *cmdline_parser_method_values[] = {"H", "A", "F", "I", 0}; /*< Possible values for method. */
...
void clear_args (struct gengetopt_args_info *args_info)
{
  ...
  args_info->method_arg = gengetopt_strdup ("H");
  ...
  args_info->ratesfile_arg = NULL;
  args_info->ratesfile_orig = NULL;
...
void init_args_info(struct gengetopt_args_info *args_info)
{
  ...
  args_info->ratesfile_help = gengetopt_args_info_help[19] ;
...
{
  unsigned int i;
  free_string_field (&(args_info->absorb_orig));
  free_string_field (&(args_info->method_arg));
  free_string_field (&(args_info->method_orig));
  free_string_field (&(args_info->t0_orig));
  free_string_field (&(args_info->t8_orig));
  free_string_field (&(args_info->Temp_orig));
  free_string_field (&(args_info->nstates_orig));
  free_multiple_string_field (args_info->p0_given, &(args_info->p0_arg), &(args_info->p0_orig));
  free_string_field (&(args_info->tinc_orig));
  free_string_field (&(args_info->ratesfile_arg));
  free_string_field (&(args_info->ratesfile_orig));
...
cmdline_parser_dump(FILE *outfile, struct gengetopt_args_info *args_info)
{
  ...
  if (args_info->absorb_given)
    write_into_file(outfile, "absorb", args_info->absorb_orig, 0);
  ...
  if (args_info->t8_given)
    write_into_file(outfile, "t8", args_info->t8_orig, 0);
  if (args_info->Temp_given)
    write_into_file(outfile, "Temp", args_info->Temp_orig, 0);
  if (args_info->nstates_given)
    write_into_file(outfile, "nstates", args_info->nstates_orig, 0);
  write_multiple_into_file(outfile, args_info->p0_given, "p0", args_info->p0_orig, 0);
  if (args_info->tinc_given)
    write_into_file(outfile, "tinc", args_info->tinc_orig, 0);
  if (args_info->degeneracy_given)
    write_into_file(outfile, "degeneracy", 0, 0 );
  if (args_info->exponent_given)
    write_into_file(outfile, "exponent", 0, 0 );
  if (args_info->umatrix_given)
    write_into_file(outfile, "umatrix", 0, 0 );
  if (args_info->mathematicamatrix_given)
    write_into_file(outfile, "mathematicamatrix", 0, 0 );
  ...
  if (args_info->recover_given)
    write_into_file(outfile, "recover", 0, 0 );
  if (args_info->wrecover_given)
    write_into_file(outfile, "wrecover", 0, 0 );
  if (args_info->info_given)
    write_into_file(outfile, "info", 0, 0 );
  if (args_info->ratesfile_given)
    write_into_file(outfile, "ratesfile", args_info->ratesfile_orig, 0);
  ...
  while (1)
    {
      ...
      c = custom_getopt_long (argc, argv, "hVa:m:T:n:deuxbrwf:v", long_options, &option_index);
      ...
      switch (c)
        ...
        case 'a':	/* Make a state absorbing.  */
          ...
          if (update_arg( (void *)&(args_info->absorb_arg), 
               &(args_info->absorb_orig), &(args_info->absorb_given),
              &(local_args_info.absorb_given), optarg, 0, 0, ARG_INT,
        ...
        I ==> use rates from barriers.  */
          ...
          if (update_arg( (void *)&(args_info->method_arg), 
              ...
              &(local_args_info.method_given), optarg, cmdline_parser_method_values, "H", ARG_STRING,
              check_ambiguity, override, 0, 0,
              "method", 'm',
              additional_error))
            goto failure;
        ...
        case 'n':	/* Read <int> states.  */
          ...
          if (update_arg( (void *)&(args_info->nstates_arg), 
               &(args_info->nstates_orig), &(args_info->nstates_given),
              &(local_args_info.nstates_given), optarg, 0, 0, ARG_INT,
              check_ambiguity, override, 0, 0,
              "nstates", 'n',
              additional_error))
            goto failure;
        ...
        case 'd':	/* Consider degeracy in transition rates.  */
          ...
          if (update_arg((void *)&(args_info->degeneracy_flag), 0, &(args_info->degeneracy_given),
              &(local_args_info.degeneracy_given), optarg, 0, 0, ARG_FLAG,
              check_ambiguity, override, 1, 0, "degeneracy", 'd',
              additional_error))
            goto failure;
        ...
        case 'e':	/* Use matrix-expontent routines, NO diagonalization.  */
          ...
          if (update_arg((void *)&(args_info->exponent_flag), 0, &(args_info->exponent_given),
              &(local_args_info.exponent_given), optarg, 0, 0, ARG_FLAG,
              check_ambiguity, override, 1, 0, "exponent", 'e',
              additional_error))
            goto failure;
        ...
        case 'u':	/* Dump transition matrix U to a binary file mx.bin.  */
          ...
          if (update_arg((void *)&(args_info->umatrix_flag), 0, &(args_info->umatrix_given),
              &(local_args_info.umatrix_given), optarg, 0, 0, ARG_FLAG,
              check_ambiguity, override, 1, 0, "umatrix", 'u',
              additional_error))
            goto failure;
        ...
        case 'x':	/* Dump transition matrix U to Mathematica-readable file mxMat.txt.  */
          ...
          if (update_arg((void *)&(args_info->mathematicamatrix_flag), 0, &(args_info->mathematicamatrix_given),
              &(local_args_info.mathematicamatrix_given), optarg, 0, 0, ARG_FLAG,
              check_ambiguity, override, 1, 0, "mathematicamatrix", 'x',
              additional_error))
            goto failure;
        ...
        case 'b':	/* assume binary input.  */
          ...
          if (update_arg((void *)&(args_info->bin_flag), 0, &(args_info->bin_given),
              ...
              check_ambiguity, override, 1, 0, "bin", 'b',
              additional_error))
            goto failure;
        ...
        case 'r':	/* Recover from pre-calculated Eigenvalues and Eigenvectors.  */
          ...
          if (update_arg((void *)&(args_info->recover_flag), 0, &(args_info->recover_given),
              &(local_args_info.recover_given), optarg, 0, 0, ARG_FLAG,
              check_ambiguity, override, 1, 0, "recover", 'r',
              additional_error))
            goto failure;
        ...
        case 'w':	/* Write recovery file containing Eigenvalues and Eigenvectors.  */
          ...
          if (update_arg((void *)&(args_info->wrecover_flag), 0, &(args_info->wrecover_given),
              &(local_args_info.wrecover_given), optarg, 0, 0, ARG_FLAG,
              check_ambiguity, override, 1, 0, "wrecover", 'w',
              additional_error))
            goto failure;
        
          break;
        case 'f':	/* Name of the textfile containing the (barriers) rate matrix
        (NOTE: the rate matrix must have been print out with '%10.4g' per entry otherwise treekin will calculate crap.  */
        
        
          if (update_arg( (void *)&(args_info->ratesfile_arg), 
               &(args_info->ratesfile_orig), &(args_info->ratesfile_given),
              &(local_args_info.ratesfile_given), optarg, 0, 0, ARG_STRING,
              check_ambiguity, override, 0, 0,
              "ratesfile", 'f',
              additional_error))
            goto failure;
        ...
        case 0:	/* Long option with no short option */
          ...
          else if (strcmp (long_options[option_index].name, "t8") == 0)
          {
            ...
            if (update_arg( (void *)&(args_info->t8_arg), 
                 &(args_info->t8_orig), &(args_info->t8_given),
                &(local_args_info.t8_given), optarg, 0, 0, ARG_DOUBLE,
                check_ambiguity, override, 0, 0,
                "t8", '-',
                additional_error))
              goto failure;
          ...
          else if (strcmp (long_options[option_index].name, "tinc") == 0)
          {
            ...
            if (update_arg( (void *)&(args_info->tinc_arg), 
                 &(args_info->tinc_orig), &(args_info->tinc_given),
                &(local_args_info.tinc_given), optarg, 0, 0, ARG_DOUBLE,
                check_ambiguity, override, 0, 0,
                "tinc", '-',
                additional_error))
              goto failure;
