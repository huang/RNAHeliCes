...
//   FILE *fp = fopen("~//temp//RNAHeliCes-1.1.2//src//test.txt","w");
//   if(fp)
//   {
//     int i = 0;
//     for(;i<10;i++)
...
//@@  printf("Checkpoint 2\n");
  if (filename) {
    read_parameter_file(filename);  // this is in librna/vienna/energy_par.c
    //@@ printf("begin writing the paramter_program.format\n");
    //@@ write_parameter_file2("parameter_program.format");
  }
  if (P)
    free(P);
  model_detailsT md;
